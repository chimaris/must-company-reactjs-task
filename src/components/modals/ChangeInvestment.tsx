							...
							<DialogPanel className="w-[800px] flex flex-col justify-start items-start transform rounded-xl shadow-[#1018281A]/10 bg-white text-left align-middle shadow-xl transition-all">
								...
								<div className="py-5 px-6 w-full border-y border-[#D7D8DA] ">
									<div className="w-full border border-[#D7D8DA] mb-3 grid grid-cols-12">
										<div className="col-span-3 text-base leading-none font-medium p-4 bg-[#EEF0F4] border-b border-b-white">회원번호</div>
										<div className="col-span-9 text-sm leading-4 py-4 px-5 bg-white border-b border-b-[#D7D8DA]">
											abc111, abc111, abc111, abc111, abc111
										</div>
										<div className="col-span-3 text-base leading-none font-medium p-4 bg-[#EEF0F4] border-b border-b-white">회원명/법인명</div>
										<div className="col-span-9 text-sm leading-4 py-4 px-5 bg-white border-b border-b-[#D7D8DA]">김길동</div>
										<div className="col-span-3 flex items-center text-base leading-none font-medium p-4 bg-[#EEF0F4]">
											<p className="">투자유형</p>
											<img src={dot} alt="dot" className="-mt-4 ml-1" />
										</div>
								...
								<div className="flex w-full py-6 justify-center gap-3 ">
									<Button title="확인" onClick={closeModal} />

									<Button style="bg-transparent border border-[#2A3958] text-[#2A3958]" title="취소" onClick={closeModal} />
								</div>
							</DialogPanel>
						</TransitionChild>
					</div>
